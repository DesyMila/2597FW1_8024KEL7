...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><span>Halaman Guru</span></a>
      ...
      <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{url('matapelajaran_guru')}}"><i class="glyphicon glyphicon-file"></i>Mata Pelajaran</a></li>
            <li><a href="{{url('jadwal_matapelajaran_guru')}}"><i class="glyphicon glyphicon-file"></i>Jadwal Mata Pelajaran</a></li>
            <li class="divider"></li>
            <li><a href="{{url('jadwal_matapelajaran_guru')}}"><i class="glyphicon glyphicon-file"></i>Jadwal Mata Pelajaran</a></li>
            <li class="divider"></li
