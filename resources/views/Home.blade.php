...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="coba/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="coba/css/landing-page.css" rel="stylesheet">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1>KAMI SIAP MEMBERIKAN INFORMASI SEPUTAR</h1>
                        <h1>SMP PROJECT</h1>
                        <h2>SEMOGA MEMBANTU ANDA</h2>
                        <hr class="intro-divider">
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="{{url('/login')}}" class="btn btn-default btn-lg"></i> <span class="network-name">Login</span></a>
                            </li>
