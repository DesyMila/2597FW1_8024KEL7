...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><span>Halaman Siswa</span></a>
      ...
      <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar"> 
		<ul class="nav menu">
            <li><a href="{{url('jeniseskul_siswa')}}"><i class="glyphicon glyphicon-file"></i>Data Jenis Eskul</a></li>
            <li><a href="{{url('jadwal_matapelajaran_siswa')}}"><i class="glyphicon glyphicon-file"></i>Jadwal Mata Pelajaran</a></li>
            <li><a href="{{url('eskul_siswa_siswa')}}"><i class="glyphicon glyphicon-file"></i>Data Ekstrakulikuler Siswa</a></li>
		</ul>
